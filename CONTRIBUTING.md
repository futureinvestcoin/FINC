Contributing to FutureInvest Core
============================

The FutureInvest Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FutureInvest Core project, and is not to be
confused with overall finc Network Protocol consensus changes.

Whether a pull request is merged into FutureInvest Core rests with the project merge
...
Patches that change finc consensus rules are considerably more involved than
...
Where a patch set proposes to change the finc consensus, it must have been
...
The project leader is the release manager for each FutureInvest Core release.
