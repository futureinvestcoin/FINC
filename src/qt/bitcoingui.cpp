                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("FutureInvest Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a finc address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and finc: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zFINC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FutureInvest Core"), this);
    aboutAction->setStatusTip(tr("Show information about FutureInvest Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for finc"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your finc addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified finc addresses"));
    ...
    openAction->setStatusTip(tr("Open a finc: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the FutureInvest Core help message to get a list with possible finc command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FutureInvest Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to finc network", "", count));
}
...
{
    QString strTitle = tr("FutureInvest Core"); // default title
...
/** Creates context menu, its actions, and fincs up all the relevant signals for mouse events. */
