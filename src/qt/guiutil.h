...
/** Utility functions used by the finc Qt UI.
 */
namespace GUIUtil
{
...
// Render finc addresses in mofincpace font
...
// Parse "finc:" URI into recipient object, return true on successful parsing
