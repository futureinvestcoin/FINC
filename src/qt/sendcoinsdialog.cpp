...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    foreach (const SendCoinsRecipient& rcp, recipients) {
        ...
        // generate mofincpace address string
        QString address = "<span style='font-family: mofincpace;'>" + rcp.address;
        address.append("</span>");
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel()) {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid finc address"));
        } else // Valid address
        {
            CPubKey pubkey;
            CKeyID keyid;
