...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 23500;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // finc starting difficulty is 1 / 2^12
        ...
        nTargetSpacing = 1 * 60;  // finc: 1 min
        nMaturity = 111;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "The 2018 Bitcoin Mining Ecosystem Saw Record Hashrates and New Devices";
