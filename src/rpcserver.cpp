...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* finc features */
        {"finc", "masternode", &masternode, true, true, false},
        {"finc", "listmasternodes", &listmasternodes, true, true, false},
        {"finc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"finc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"finc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"finc", "masternodedebug", &masternodedebug, true, true, false},
        {"finc", "startmasternode", &startmasternode, true, true, false},
        {"finc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"finc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"finc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"finc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"finc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"finc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"finc", "mnbudget", &mnbudget, true, true, false},
        {"finc", "preparebudget", &preparebudget, true, true, false},
        {"finc", "submitbudget", &submitbudget, true, true, false},
        {"finc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"finc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"finc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"finc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"finc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"finc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"finc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"finc", "checkbudgets", &checkbudgets, true, true, false},
        {"finc", "mnsync", &mnsync, true, true, false},
        {"finc", "spork", &spork, true, true, false},
        {"finc", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"finc", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use fincd, or the -server option to finc-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> finc-cli " + methodname + " " + args + "\n";
}
