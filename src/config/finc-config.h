/* src/config/finc-config.h.  Generated from finc-config.h.in by configure.  */
/* src/config/finc-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef FINC_CONFIG_H

#define FINC_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.finc.cash"

/* Define to the full name of this package. */
#define PACKAGE_NAME "FutureInvest Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "FutureInvest Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "finc"
