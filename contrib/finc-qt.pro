...
RESOURCES += src/qt/finc.qrc src/qt/finc_locale.qrc

TRANSLATIONS += src/qt/locale/finc_bg.ts \
                src/qt/locale/finc_de.ts \
                src/qt/locale/finc_en.ts \
                src/qt/locale/finc_es.ts \
                src/qt/locale/finc_fi.ts \
                src/qt/locale/finc_fr.ts \
                src/qt/locale/finc_it.ts \
                src/qt/locale/finc_ja.ts \
                src/qt/locale/finc_pl.ts \
                src/qt/locale/finc_pt.ts \
                src/qt/locale/finc_ru.ts \
                src/qt/locale/finc_sk.ts \
                src/qt/locale/finc_sv.ts \
                src/qt/locale/finc_vi.ts \
                src/qt/locale/finc_zh_CN.ts \
                src/qt/locale/finc_zh_TW.ts
