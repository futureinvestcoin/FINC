...
In order to support loading of multiple wallets in finc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is finc.cpp.
...
Changes to finc.cpp
----------------------
finc.cpp is the entry point into finc-qt, and as such, will require some minor modifications to provide hooks for
